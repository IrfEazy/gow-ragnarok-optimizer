...
def test_piece_toggle_state_reflects_craft_false():
    ...
    web_data = {
        'chest_pieces': [{'name': 'Cuirass of Zeus', 'level': 5, 'craft': False, 'locked': False}],
        'wrist_pieces': [],
        'waist_pieces': [],
        'axe_attachments': [],
        'blades_attachments': [],
...
def test_piece_toggle_state_reflects_craft_true():
    ...
    web_data = {
        'chest_pieces': [{'name': 'Cuirass of Zeus', 'level': 3, 'craft': True, 'locked': False}],
        'wrist_pieces': [],
        'waist_pieces': [],
        'axe_attachments': [],
        'blades_attachments': [],
...
def test_locked_piece_shows_locked_state():
    ...
    web_data = {
        'chest_pieces': [{'name': 'Cuirass of Zeus', 'level': 5, 'craft': False, 'locked': True}],
        'wrist_pieces': [],
        'waist_pieces': [],
        'axe_attachments': [],
        'blades_attachments': [],
...
def test_locked_pieces_excluded_from_optimization():
    ...
    assert 'Cuirass of Ares' not in piece_names, "Locked piece should not be in inventory"
